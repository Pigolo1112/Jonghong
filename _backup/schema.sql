...
-- ===== SAMPLE DATA =====
-- ห้องประชุมตัวอย่าง (รันหลังจากสร้างตารางแล้ว)
INSERT INTO rooms (name, building, floor, capacity, equipment, description, is_active, allowed_roles) VALUES
('ห้องประชุม SC101', 'อาคารวิทยาศาสตร์ 1', 1, 20, '["โปรเจกเตอร์", "ไวท์บอร์ด", "ไมโครโฟน", "เครื่องปรับอากาศ"]'::jsonb, 'ห้องประชุมขนาดกลาง เหมาะสำหรับการประชุมภาควิชา', true, ARRAY['admin', 'staff', 'student']),
('ห้องประชุม SC201', 'อาคารวิทยาศาสตร์ 1', 2, 50, '["โปรเจกเตอร์", "ระบบเสียง", "ไมโครโฟนไร้สาย", "กล้อง Video Conference", "เครื่องปรับอากาศ"]'::jsonb, 'ห้องประชุมขนาดใหญ่ สำหรับสัมมนาและประชุมคณะ', true, ARRAY['admin', 'staff']),
('ห้องประชุม DI301', 'อาคารนวัตกรรมดิจิทัล', 3, 15, '["จอ LED 65 นิ้ว", "ไวท์บอร์ด", "ระบบ Video Conference", "เครื่องปรับอากาศ"]'::jsonb, 'ห้องประชุมสำหรับทีมวิจัย มีอุปกรณ์ประชุมออนไลน์', true, ARRAY['admin', 'staff', 'student']),
('ห้องประชุม DI102', 'อาคารนวัตกรรมดิจิทัล', 1, 30, '["โปรเจกเตอร์", "ระบบเสียง", "ไมโครโฟน", "เครื่องปรับอากาศ"]'::jsonb, 'ห้องประชุมขนาดกลาง-ใหญ่ สำหรับจัดอบรมและ Workshop', true, ARRAY['admin', 'staff']),
('ห้องประชุมย่อย SC105', 'อาคารวิทยาศาสตร์ 1', 1, 8, '["จอ TV 55 นิ้ว", "ไวท์บอร์ด", "เครื่องปรับอากาศ"]'::jsonb, 'ห้องประชุมขนาดเล็ก สำหรับประชุมกลุ่มย่อย', true, ARRAY['admin', 'staff', 'student'])
